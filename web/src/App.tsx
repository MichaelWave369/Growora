  ...
  return (
    <div className="app">
      ...
      <Routes>
        ...
        <Route path="/lan" element={<LanHostPage />} />
        <Route path="/join/:roomCode" element={<JoinRoomPage />} />
        <Route path="/lan/session/:roomCode" element={<LanSessionPage />} />
      </Routes>
    </div>
  )
}
